...
# from codec_args import get_codec_args
# from compress_dominator import compress, bi_compress
# from compress import compress, bi_compress
from compress_optimize_external_entropy_coding import compress
...
if __name__ == '__main__':
    ...
    for pure_base in pure_base_list:
        ...
        if args.bi_direction:
            bi_compress(args, (compress_model, backward_model), lut=lut, stride=args.predict_base_num)
        else:
